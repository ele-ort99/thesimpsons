...
function App() {
  ...
  return (
    <>
      <img
      className='title'
       src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/bc/The_Simpsons_Logo.svg/1200px-The_Simpsons_Logo.svg.png" />
      <h2>
        Descubre las mejores frases
        <br />
      ...
      {mostrarCards ? (
        <div>
          <CardApp className="cards" cards={cards}></CardApp>
          <button
